...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>End-to-end custom web applications built with React, Next.js, and Node.js.</p>
    </td>
    <td width="50%" valign="top">
      <h4>🚀 SaaS Products</h4>
      <p>Scalable software-as-a-service platforms with user management, payments, and analytics.</p>
    </td>
  </tr>
  <tr>
    <td valign="top">
      <h4>⚡ Business Automation</h4>
      <p>Custom scripts and tools to automate manual workflows and boost operational efficiency.</p>
    </td>
    <td valign="top">
      <h4>📊 Admin Dashboards</h4>
      <p>Beautiful dashboards with analytics, reporting, user management, and control panels.</p>
    </td>
  </tr>
  <tr>
    <td valign="top">
      <h4>📈 Performance Optimization</h4>
      <p>Optimizing load times, SEO structure, database queries, and general site speed.</p>
    </td>
    <td valign="top">
      <h4>🔌 Custom APIs &amp; Integrations</h4>
      <p>Designing robust REST/GraphQL APIs and integrating third-party services.</p>
    </td>
  </tr>
</table>
